...
namespace Ghost.Presentation.Act5.Editor
{
    public static class Act5TestingPrototypeSceneBuilder
    {
        [MenuItem("Ghost/Build Act 5 Testing and Debugging Scene")]
        public static void BuildAct5TestingPrototypeScene()
        {
            ...
            EditorSceneManager.SaveScene(scene, ShellSceneNames.Act5ScenePath);
            AppendSceneToBuildSettings(ShellSceneNames.Act5ScenePath);
        ...
        private static void CreateActRoot(Transform parent)
        {
            ...
            var presenter = root.gameObject.AddComponent<Act5TestingStaticPresenter>();
